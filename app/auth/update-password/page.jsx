        ...
        <div className='flex flex-col bg-black/10 w-full max-w-md border border-white/30 rounded-sm px-6 py-8 gap-6'>
            ...
            <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                ...
                <div className=' relative'>
                    ...
                    hover:text-gray-700" disabled={loading} onClick={() => setShowPassword(!showPassword)}>
                ...
                <div className=' relative'>
                    ...
                    />
                    <button type='button' className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500
                    hover:text-gray-700" disabled={loading} onClick={() => setShowConfirmPassword(!showConfirmPassword)}>

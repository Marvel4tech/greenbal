...
const Page = () => {
  ...
  const handleSaveResult = async () => {
    if (!result || !selectedGames) return;
    if (savingResult) return; // Prevent double submission
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 z-50">
          <div className="bg-white dark:bg-black/90 p-6 rounded-lg shadow-xl w-[90%] max-w-md">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => !savingResult && setShowModal(false)}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                } ${savingResult ? "opacity-50 cursor-not-allowed" : ""}`}
              >
                Home Win
              </button>
            ...
            <button
              onClick={handleSaveResult}
              disabled={savingResult || !result}
              className="mt-5 bg-primary text-white px-4 py-2 rounded-md w-full font-semibold hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {savingResult ? (
                <>

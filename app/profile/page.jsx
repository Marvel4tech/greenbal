      ...
      <main className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-sm relative">
        <div className="flex flex-col md:flex-row h-full py-6 px-4 md:px-8 gap-4">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            {/* Recent Predictions */}
            <div className="relative overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-black/70 shadow-xl">
              ...
              <div className="relative p-4 border-b border-gray-200 dark:border-white/10">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-white/60">
                        Your last 10 predictions for this week
                      </p>
                    </div>
                  </div>
                ...
                <p className="mt-3 text-[11px] leading-5 text-gray-600 dark:text-white/70">
                ...
                <table className="w-full min-w-[500px] text-xs">
                  <thead className="bg-gray-50 dark:bg-white/5">
                    <tr>
                      ...
                      <th className="px-4 py-2.5 text-left">Prediction</th>
                      <th className="px-4 py-2.5 text-left">Status</th>
                      <th className="px-4 py-2.5 text-left">Points</th>
                    </tr>
                  </thead>

  ...
  const loadStats = useCallback(async () => {
    try {
      ...
      try {
        ...
        throw new Error('Server did not return JSON. Check stats API response.')
      }
          ...
          <div className='flex-1 flex flex-col gap-6'>
            ...
            <div className='bg-white dark:bg-black/70 border shadow-xl rounded-lg p-5 flex flex-col justify-between hover:scale-[1.01] transition-transform duration-200'>
              ...
              <p className='text-sm text-gray-500 dark:text-gray-400'>
                Predictions submitted for the current weekly round
              </p>
            ...
            <div className='bg-white dark:bg-black/70 border shadow-xl rounded-lg p-5 flex flex-col justify-between hover:scale-[1.01] transition-transform duration-200'>
              ...
              <p className='text-sm text-gray-500 dark:text-gray-400'>
                Based on graded predictions for this week
              </p>

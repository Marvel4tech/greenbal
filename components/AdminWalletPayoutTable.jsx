...
export default function AdminWalletPayoutTable({ initialTxs }) {
    ...
    <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-black/40 overflow-hidden shadow-sm">
      <div className="px-5 py-4 border-b border-gray-200 dark:border-white/10">
        ...
        <p className="text-sm text-gray-600 dark:text-white/60">
          Each row is one user. Paying them marks all their available wallet transactions as paid.
        </p>
      </div>
      ...
      <div className="divide-y divide-gray-200 dark:divide-white/10">
        ...
        {!grouped.length && (
          <div className="px-5 py-10 text-sm text-gray-500 dark:text-white/60">
            No available wallet payouts right now.
          </div>
        )}
      </div>
    </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div className="lg:col-span-4">
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-white/50">
            {group.tx_count} available transaction{group.tx_count > 1 ? "s" : ""}
          </p>
        ...
        <div className="lg:col-span-2">
          <p className="text-xs text-gray-500 dark:text-white/50">Available total</p>
